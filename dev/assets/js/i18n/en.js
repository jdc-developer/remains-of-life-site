$(function() {
    $.i18n().load({
		...
		'new-single-content-2': 'Shattered Mirror is a slow and exceptionally melancolic song, even for the high dramatic standards of the album. Its pacing goes through melodic phrases and intense and explosive guitar arrangements. You may check it on the main digital platforms and on the band\'s YouTube channel, where we uploaded an amazing lyric video produced by Wolff Videomaker. We wish to thank Alef Marra for the cover art, Marcel Briani for the edition and Victor Zavinsck for the logo drawing. You can watch the lyric video below:'
    }, 'en');
});
